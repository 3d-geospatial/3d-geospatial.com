---
title: "LiDAR Classification and Ground Extraction"
description: "Classify LiDAR returns and extract bare earth with PDAL: SMRF and CSF parameters, ASPRS codes, confusion-matrix scoring, and gates that catch a bad filter."
---
