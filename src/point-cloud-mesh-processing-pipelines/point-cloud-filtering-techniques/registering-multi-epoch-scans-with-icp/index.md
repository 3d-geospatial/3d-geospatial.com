---
title: "Registering Multi-Epoch Scans with ICP"
description: "Align two survey epochs without dragging real change into the fit: stable-surface masking, coarse-to-fine ICP in Open3D, and residuals that separate misfit from movement."
---
