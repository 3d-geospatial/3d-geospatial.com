---
title: "Caching PROJ and GDAL Layers in CI"
description: "Cut a spatial CI job from ten minutes to four: pin the container by digest, cache PROJ data by release, cache conda and pip layers, and key each cache correctly."
---
