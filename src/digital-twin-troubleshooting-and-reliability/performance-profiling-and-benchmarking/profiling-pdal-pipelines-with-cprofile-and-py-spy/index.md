---
title: "Profiling PDAL Pipelines with cProfile and py-spy"
description: "Find where a PDAL job's wall clock goes: stage timings from pipeline metadata, native flame graphs with py-spy, and separating I/O from filter cost."
---
