---
title: "Alerting on Tile Error Rates from CDN Logs"
description: "Turn CDN access logs into tile-serving alerts: parse per tileset version, split 404 from 5xx, watch cache hit ratio and set thresholds that catch a bad"
---
