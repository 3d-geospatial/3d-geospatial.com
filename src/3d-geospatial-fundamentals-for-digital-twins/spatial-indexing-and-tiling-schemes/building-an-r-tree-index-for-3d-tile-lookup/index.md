---
title: "Building an R-tree Index for 3D Tile Lookup"
description: "Bulk-load an R-tree over tile bounding volumes with rtree/libspatialindex, tune leaf capacity, add the Z dimension only where it pays, and detect a stale index."
---
